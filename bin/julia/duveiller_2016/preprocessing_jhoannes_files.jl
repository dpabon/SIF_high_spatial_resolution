...
sif_files = glob(
    "SIF_*.nc",
    "/Net/Groups/BGI/data/DataStructureMDI/DATA/Incoming/TROPOSIF/gridded/Europe_h17-h20_v2-v5/SIF_10km_filtered/",
)
...
grid = Cube(
    open_dataset(
        "/Net/Groups/BGI/data/DataStructureMDI/DATA/Incoming/TROPOSIF/gridded/Europe_h17-h20_v2-v5/SIF_10km_filtered/grid_h17-h20_v2-v5_10km.nc",
    ),
)
...
axlist = (Dim{:X}(1:480), Dim{:Y}(1:480), Dim{:time}(time), Dim{:Variable}(Variable))
...
grid = Cube(
    open_dataset(
        "/Net/Groups/BGI/scratch/jgens/Sentinel3/gridded/LST_1km/grid_h17-h20_v2-v5_1km.nc",
    ),
)
...
axlist = (Dim{:X}(1:4800), Dim{:Y}(1:4800), Dim{:time}(time), Dim{:Variable}(Variable))
...
grid = Cube(
    open_dataset(
        "/Net/Groups/BGI/scratch/jgens/Sentinel3/gridded/OLCI_1km/grid_h17-h20_v2-v5_1km.nc",
    ),
)
...
MC43A4_files =
    glob("MCD43A4_*.nc", "/Net/Groups/BGI/scratch/jgens/Modis/gridded/MCD43A4_1km/")
...
YAXArrays.Datasets.open_mfdataset(
    "/Net/Groups/BGI/scratch/jgens/Modis/gridded/MCD43A4_1km/MCD*.nc",
)
...
grid = Cube(
    open_dataset(
        "/Net/Groups/BGI/scratch/jgens/Modis/gridded/MCD43A4_1km/grid_h17-h20_v2-v5_1km.nc",
    ),
)
...
z1 = zcreate(
    ...
    976,
    9,
    path = "/Net/Groups/BGI/work_3/OEMC/oemc_sif/data/MC43A4_gridded_1km_europe_2018-05-01_2020-12-31.zarr",
    chunks = (4800, 4800, 1, 1),
)
...
MOD11A1_files =
    glob("MOD11A1_*.nc", "/Net/Groups/BGI/scratch/jgens/Modis/gridded/MOD11A1_1km/")
...
grid = Cube(
    open_dataset(
        "/Net/Groups/BGI/scratch/jgens/Modis/gridded/MOD11A1_1km/grid_h17-h20_v2-v5_1km.nc",
    ),
)
...
z1 = zcreate(
    ...
    length(time),
    4,
    path = "/Net/Groups/BGI/work_3/OEMC/oemc_sif/data/MOD11A1_gridded_1km_europe_2018-05-01_2020-12-31.zarr",
    chunks = (4800, 4800, 1, 1),
)
...
savecube(
    ds,
    "/Net/Groups/BGI/work_3/OEMC/oemc_sif/data/MOD11A1_gridded_1km_europe_2018-05-01_2020-12-31_YAXA.zarr",
)
