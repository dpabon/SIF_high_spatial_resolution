...
nc_cubes =
    Cube.([open_dataset(nc_path .* files_nc[i])[["SIF"]] for i in eachindex(files_nc)])
...
CSV.write(
    "/Net/Groups/BGI/work_3/OEMC/oemc_sif/data/OEMC_app_data/start_end_dates.csv",
    out_csv,
)
